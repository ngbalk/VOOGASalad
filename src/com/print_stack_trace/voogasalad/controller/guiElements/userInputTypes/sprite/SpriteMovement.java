...
public class SpriteMovement extends SpriteUserInputDropDown{
	...
	protected void loadInitialFunction(String name, Object type) {
		HashMap<KeyCode, KeyResult> myMovements=(HashMap<KeyCode, KeyResult>) type;
		for (KeyResult myAction: KeyResult.values()){
	...
	protected Object getCharacteristicType() {
		return ((SpriteObject) mySprite).getCharacteristics().getMovements();
	}
